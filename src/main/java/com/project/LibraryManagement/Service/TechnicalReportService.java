...
public class TechnicalReportService {
    ...
    public ResponseEntity<Object> createTechnicalReport(TechnicalReport technicalReport) {
        try {
            ...
            return ResponseHandler.generateResponse("The exception is :: " + e.getMostSpecificCause(), HttpStatus.BAD_REQUEST, null, "TechnicalReport");
        } catch (Exception e) {
            return ResponseHandler.generateResponse("The exception is :: " + e.getLocalizedMessage(), HttpStatus.BAD_REQUEST, null, "TechnicalReport");
        }
    }
